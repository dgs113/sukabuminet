        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <h4>Edit Berita</h4>
                    <hr>
                    <form action="{{ url('/dashboard/berita/' . $post->slug) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <input class="form-control @error('title') is-invalid @enderror" name="title" type="text"
                                value="{{ old('title', $post->title) }}" id="judul-berita" autofocus required>
                            @error('title')
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 d-flex align-items-center">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" value="true" name="is_headline"
                                        id="checkHeadline" @if ($post->is_headline == true) {{ 'checked' }} @endif>
                            ...
                            <div class="col-lg-2 col-md-6  col-sm-6 d-flex align-items-center">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" value="true" name="is_archive"
                                        id="checkArsip" @if ($post->is_archive == true) {{ 'checked' }} @endif>
